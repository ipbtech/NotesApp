    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseSubscription", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseLike", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Note_CreatedAtUtc",
                table: "Note",
                column: "CreatedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_Note_LikesCount",
                table: "Note",
                column: "LikesCount");

            migrationBuilder.CreateIndex(
                name: "IX_Note_PrivacyStatus",
                table: "Note",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoteImage_NoteId_Order",
                table: "NoteImage",
